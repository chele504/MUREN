...
class AddDarkStripeTrigger(object):
    def __init__(self, width_ratio: float = 0.15, darken: float = 0.0, position: str = "left"):
        self.width_ratio = float(width_ratio)
        self.darken = float(darken)
        self.position = str(position or "left")
